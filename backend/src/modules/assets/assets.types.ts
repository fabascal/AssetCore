...
export const assetDecommissionReasons = ["END_OF_LIFE", "DAMAGE", "THEFT", "OTHER"] as const;
export type AssetDecommissionReason = (typeof assetDecommissionReasons)[number];
