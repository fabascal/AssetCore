...
DO $$ BEGIN CREATE TYPE vehicle_type AS ENUM ('SEDAN', 'SUV', 'PICKUP', 'VAN', 'TRUCK', 'MOTORCYCLE', 'OTHER'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE vehicle_document_type AS ENUM ('CARTA_COMPROMISO', 'TARJETA_CIRCULACION', 'POLIZA_SEGURO', 'FACTURA_MANTENIMIENTO', 'FACTURA_COMPRA', 'VERIFICACION', 'OTRO'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
